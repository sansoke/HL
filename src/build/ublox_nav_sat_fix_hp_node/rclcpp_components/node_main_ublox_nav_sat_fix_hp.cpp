...
#define NODE_MAIN_LOGGER_NAME "ublox_nav_sat_fix_hp"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libublox_nav_sat_fix_hp_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ublox_nav_sat_fix_hp::UbloxNavSatHpFixNode>";
