...
bool ublox_ubx_msgs__msg__ubx_rxm_spartn__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_rxm_spartn.UBXRxmSpartn", full_classname_dest, 47) == 0);
  }
  ublox_ubx_msgs__msg__UBXRxmSpartn * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UBXRxmSpartn */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_rxm_spartn");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXRxmSpartn");
