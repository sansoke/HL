...
#include "ublox_ubx_msgs/msg/detail/psmpvt__rosidl_typesupport_fastrtps_c.h"
...
using _PSMPVT__ros_msg_type = ublox_ubx_msgs__msg__PSMPVT;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PSMPVT__ros_msg_type * ros_message = static_cast<const _PSMPVT__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PSMPVT__ros_msg_type * ros_message = static_cast<_PSMPVT__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
    cdr >> ros_message->state;
  }
...
static uint32_t _PSMPVT__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_ubx_msgs__msg__PSMPVT(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs__msg__PSMPVT;
    is_plain =
      (
...
static size_t _PSMPVT__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ublox_ubx_msgs__msg__PSMPVT(
...
static message_type_support_callbacks_t __callbacks_PSMPVT = {
  "ublox_ubx_msgs::msg",
  "PSMPVT",
...
static rosidl_message_type_support_t _PSMPVT__type_support = {
