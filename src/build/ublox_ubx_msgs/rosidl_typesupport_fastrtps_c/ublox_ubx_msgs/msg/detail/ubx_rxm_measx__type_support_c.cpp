...
#include "ublox_ubx_msgs/msg/detail/ubx_rxm_measx__rosidl_typesupport_fastrtps_c.h"
...
#include "ublox_ubx_msgs/msg/detail/measx_data__functions.h"  // sv_data
...
using _UBXRxmMeasx__ros_msg_type = ublox_ubx_msgs__msg__UBXRxmMeasx;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UBXRxmMeasx__ros_msg_type * ros_message = static_cast<const _UBXRxmMeasx__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: gps_tow_acc
  {
    cdr << ros_message->gps_tow_acc;
  }

  // Field name: glo_tow_acc
  {
    cdr << ros_message->glo_tow_acc;
  }

  // Field name: bds_tow_acc
  {
    cdr << ros_message->bds_tow_acc;
  }

  // Field name: qzss_tow_acc
  {
  ...
  // Field name: sv_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ublox_ubx_msgs, msg, MeasxData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _UBXRxmMeasx__ros_msg_type * ros_message = static_cast<_UBXRxmMeasx__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: sv_data
  {
    ...
    if (ros_message->sv_data.data) {
      ublox_ubx_msgs__msg__MeasxData__Sequence__fini(&ros_message->sv_data);
    }
...
size_t get_serialized_size_ublox_ubx_msgs__msg__UBXRxmMeasx(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UBXRxmMeasx__ros_msg_type * ros_message = static_cast<const _UBXRxmMeasx__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name sv_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ublox_ubx_msgs__msg__MeasxData(
...
static uint32_t _UBXRxmMeasx__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_ubx_msgs__msg__UBXRxmMeasx(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_ubx_msgs
size_t max_serialized_size_ublox_ubx_msgs__msg__UBXRxmMeasx(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: sv_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ublox_ubx_msgs__msg__MeasxData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs__msg__UBXRxmMeasx;
    is_plain =
      (
...
static size_t _UBXRxmMeasx__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ublox_ubx_msgs__msg__UBXRxmMeasx(
...
static message_type_support_callbacks_t __callbacks_UBXRxmMeasx = {
  "ublox_ubx_msgs::msg",
  "UBXRxmMeasx",
...
static rosidl_message_type_support_t _UBXRxmMeasx__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UBXRxmMeasx,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_ubx_msgs, msg, UBXRxmMeasx)() {
  return &_UBXRxmMeasx__type_support;
}
