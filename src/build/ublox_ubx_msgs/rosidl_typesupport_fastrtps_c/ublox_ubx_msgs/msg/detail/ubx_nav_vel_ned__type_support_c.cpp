...
#include "ublox_ubx_msgs/msg/detail/ubx_nav_vel_ned__rosidl_typesupport_fastrtps_c.h"
...
using _UBXNavVelNED__ros_msg_type = ublox_ubx_msgs__msg__UBXNavVelNED;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UBXNavVelNED__ros_msg_type * ros_message = static_cast<const _UBXNavVelNED__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UBXNavVelNED__ros_msg_type * ros_message = static_cast<_UBXNavVelNED__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ublox_ubx_msgs__msg__UBXNavVelNED(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UBXNavVelNED__ros_msg_type * ros_message = static_cast<const _UBXNavVelNED__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _UBXNavVelNED__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_ubx_msgs__msg__UBXNavVelNED(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_ubx_msgs
size_t max_serialized_size_ublox_ubx_msgs__msg__UBXNavVelNED(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs__msg__UBXNavVelNED;
    is_plain =
      (
...
static size_t _UBXNavVelNED__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ublox_ubx_msgs__msg__UBXNavVelNED(
...
static message_type_support_callbacks_t __callbacks_UBXNavVelNED = {
  "ublox_ubx_msgs::msg",
  "UBXNavVelNED",
...
static rosidl_message_type_support_t _UBXNavVelNED__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UBXNavVelNED,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_ubx_msgs, msg, UBXNavVelNED)() {
  return &_UBXNavVelNED__type_support;
}
