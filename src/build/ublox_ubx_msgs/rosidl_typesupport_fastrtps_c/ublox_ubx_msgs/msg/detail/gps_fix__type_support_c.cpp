...
#include "ublox_ubx_msgs/msg/detail/gps_fix__rosidl_typesupport_fastrtps_c.h"
...
using _GpsFix__ros_msg_type = ublox_ubx_msgs__msg__GpsFix;
...
static uint32_t _GpsFix__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ublox_ubx_msgs__msg__GpsFix(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs__msg__GpsFix;
    is_plain =
      (
...
static size_t _GpsFix__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ublox_ubx_msgs__msg__GpsFix(
