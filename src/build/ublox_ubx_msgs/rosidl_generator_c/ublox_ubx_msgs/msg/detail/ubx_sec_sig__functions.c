...
ublox_ubx_msgs__msg__UBXSecSig__init(ublox_ubx_msgs__msg__UBXSecSig * msg)
{
  ...
  if (!ublox_ubx_msgs__msg__JamStateCentFreq__Sequence__init(&msg->jam_state_cent_freqs, 0)) {
    ublox_ubx_msgs__msg__UBXSecSig__fini(msg);
    return false;
  }
  return true;
...
ublox_ubx_msgs__msg__UBXSecSig__fini(ublox_ubx_msgs__msg__UBXSecSig * msg)
{
  ...
  // jam_num_cent_freqs
  // jam_state_cent_freqs
  ublox_ubx_msgs__msg__JamStateCentFreq__Sequence__fini(&msg->jam_state_cent_freqs);
}
...
ublox_ubx_msgs__msg__UBXSecSig__are_equal(const ublox_ubx_msgs__msg__UBXSecSig * lhs, const ublox_ubx_msgs__msg__UBXSecSig * rhs)
{
  ...
  // jam_num_cent_freqs
  if (lhs->jam_num_cent_freqs != rhs->jam_num_cent_freqs) {
    return false;
  }
  // jam_state_cent_freqs
  if (!ublox_ubx_msgs__msg__JamStateCentFreq__Sequence__are_equal(
      &(lhs->jam_state_cent_freqs), &(rhs->jam_state_cent_freqs)))
  {
    return false;
  }
  return true;
  ...
  ublox_ubx_msgs__msg__UBXSecSig * output)
{
  ...
  // jam_num_cent_freqs
  output->jam_num_cent_freqs = input->jam_num_cent_freqs;
  // jam_state_cent_freqs
  if (!ublox_ubx_msgs__msg__JamStateCentFreq__Sequence__copy(
      &(input->jam_state_cent_freqs), &(output->jam_state_cent_freqs)))
  {
    return false;
  }
  return true;
