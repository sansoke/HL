...
struct UBXSecSig_
{
  ...
  using _jam_num_cent_freqs_type =
    uint8_t;
  _jam_num_cent_freqs_type jam_num_cent_freqs;
  using _jam_state_cent_freqs_type =
    std::vector<ublox_ubx_msgs::msg::JamStateCentFreq_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ublox_ubx_msgs::msg::JamStateCentFreq_<ContainerAllocator>>>;
  _jam_state_cent_freqs_type jam_state_cent_freqs;
  ...
  Type & set__jam_num_cent_freqs(
    const uint8_t & _arg)
  {
    this->jam_num_cent_freqs = _arg;
    return *this;
  }
  Type & set__jam_state_cent_freqs(
    const std::vector<ublox_ubx_msgs::msg::JamStateCentFreq_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ublox_ubx_msgs::msg::JamStateCentFreq_<ContainerAllocator>>> & _arg)
  {
    this->jam_state_cent_freqs = _arg;
    return *this;
  }
  ...
  bool operator==(const UBXSecSig_ & other) const
  {
    ...
    if (this->jam_num_cent_freqs != other.jam_num_cent_freqs) {
      return false;
    }
    if (this->jam_state_cent_freqs != other.jam_state_cent_freqs) {
      return false;
    }
    return true;
  }
