...
class Init_UBXSecSig_jam_state_cent_freqs
{
public:
  explicit Init_UBXSecSig_jam_state_cent_freqs(::ublox_ubx_msgs::msg::UBXSecSig & msg)
  : msg_(msg)
  {}
  ::ublox_ubx_msgs::msg::UBXSecSig jam_state_cent_freqs(::ublox_ubx_msgs::msg::UBXSecSig::_jam_state_cent_freqs_type arg)
  {
    msg_.jam_state_cent_freqs = std::move(arg);
...
class Init_UBXSecSig_jam_num_cent_freqs
{
public:
  explicit Init_UBXSecSig_jam_num_cent_freqs(::ublox_ubx_msgs::msg::UBXSecSig & msg)
  : msg_(msg)
  {}
  Init_UBXSecSig_jam_state_cent_freqs jam_num_cent_freqs(::ublox_ubx_msgs::msg::UBXSecSig::_jam_num_cent_freqs_type arg)
  {
    msg_.jam_num_cent_freqs = std::move(arg);
    return Init_UBXSecSig_jam_state_cent_freqs(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_UBXSecSig_jam_num_cent_freqs spoofing_state(::ublox_ubx_msgs::msg::UBXSecSig::_spoofing_state_type arg)
  {
    msg_.spoofing_state = std::move(arg);
    return Init_UBXSecSig_jam_num_cent_freqs(msg_);
  }
