...
{
bool cdr_serialize(
  const ublox_ubx_msgs::msg::JamStateCentFreq &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  // Member: jam_state_cent_freqs
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.jam_state_cent_freqs[i],
        cdr);
    }
  }
  return true;
  ...
  ublox_ubx_msgs::msg::UBXSecSig & ros_message)
{
  ...
  // Member: jam_state_cent_freqs
  {
    ...
    ros_message.jam_state_cent_freqs.resize(size);
    for (size_t i = 0; i < size; i++) {
      ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.jam_state_cent_freqs[i]);
    }
  }
  ...
  // Member: jam_state_cent_freqs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.jam_state_cent_freqs[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: jam_state_cent_freqs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JamStateCentFreq(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::UBXSecSig;
    is_plain =
      (
