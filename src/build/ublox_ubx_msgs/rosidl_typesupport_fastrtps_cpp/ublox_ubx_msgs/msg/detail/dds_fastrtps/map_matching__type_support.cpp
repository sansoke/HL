...
#include "ublox_ubx_msgs/msg/detail/map_matching__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_ubx_msgs::msg::MapMatching & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_ubx_msgs::msg::MapMatching & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::MapMatching;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::MapMatching *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_ubx_msgs::msg::MapMatching *>(
    untyped_ros_message);
...
static size_t _MapMatching__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MapMatching(full_bounded, is_plain, 0);
...
get_message_type_support_handle<ublox_ubx_msgs::msg::MapMatching>()
{
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_MapMatching__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, MapMatching)() {
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_MapMatching__handle;
}
