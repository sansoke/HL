...
#include "ublox_ubx_msgs/msg/detail/ubx_rxm_cor__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ublox_ubx_msgs::msg::CorStatusInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ublox_ubx_msgs::msg::UBXRxmCor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_ubx_msgs::msg::UBXRxmCor & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: status_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CorStatusInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::UBXRxmCor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXRxmCor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_ubx_msgs::msg::UBXRxmCor *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UBXRxmCor__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXRxmCor *>(
...
static size_t _UBXRxmCor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UBXRxmCor(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UBXRxmCor__callbacks = {
  "ublox_ubx_msgs::msg",
  "UBXRxmCor",
...
static rosidl_message_type_support_t _UBXRxmCor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UBXRxmCor__callbacks,
...
{
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXRxmCor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, UBXRxmCor)() {
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXRxmCor__handle;
}
