...
#include "ublox_ubx_msgs/msg/detail/ubx_nav_svin__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_ubx_msgs::msg::UBXNavSvin & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_ubx_msgs::msg::UBXNavSvin & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ublox_ubx_msgs
max_serialized_size_UBXNavSvin(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::UBXNavSvin;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXNavSvin *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_ubx_msgs::msg::UBXNavSvin *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UBXNavSvin__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXNavSvin *>(
...
static size_t _UBXNavSvin__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UBXNavSvin(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UBXNavSvin__callbacks = {
  "ublox_ubx_msgs::msg",
  "UBXNavSvin",
...
static rosidl_message_type_support_t _UBXNavSvin__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UBXNavSvin__callbacks,
...
{
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXNavSvin__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, UBXNavSvin)() {
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXNavSvin__handle;
}
