...
#include "ublox_ubx_msgs/msg/detail/gps_fix__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ublox_ubx_msgs::msg::GpsFix & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_ubx_msgs::msg::GpsFix & ros_message)
{
  // Member: fix_type
  cdr >> ros_message.fix_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::GpsFix;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::GpsFix *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_ubx_msgs::msg::GpsFix *>(
    untyped_ros_message);
...
get_message_type_support_handle<ublox_ubx_msgs::msg::GpsFix>()
{
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, GpsFix)() {
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
