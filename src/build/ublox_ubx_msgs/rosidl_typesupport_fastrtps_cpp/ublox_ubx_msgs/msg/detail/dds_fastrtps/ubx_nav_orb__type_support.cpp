...
#include "ublox_ubx_msgs/msg/detail/ubx_nav_orb__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ublox_ubx_msgs::msg::OrbSVInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ublox_ubx_msgs::msg::UBXNavOrb & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ublox_ubx_msgs::msg::UBXNavOrb & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: sv_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_OrbSVInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ublox_ubx_msgs::msg::UBXNavOrb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXNavOrb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ublox_ubx_msgs::msg::UBXNavOrb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UBXNavOrb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ublox_ubx_msgs::msg::UBXNavOrb *>(
...
static size_t _UBXNavOrb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UBXNavOrb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UBXNavOrb__callbacks = {
  "ublox_ubx_msgs::msg",
  "UBXNavOrb",
...
static rosidl_message_type_support_t _UBXNavOrb__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UBXNavOrb__callbacks,
...
{
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXNavOrb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, UBXNavOrb)() {
  return &ublox_ubx_msgs::msg::typesupport_fastrtps_cpp::_UBXNavOrb__handle;
}
