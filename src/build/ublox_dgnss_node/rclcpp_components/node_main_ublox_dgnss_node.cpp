...
#define NODE_MAIN_LOGGER_NAME "ublox_dgnss_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libublox_dgnss_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ublox_dgnss::UbloxDGNSSNode>";
