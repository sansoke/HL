...
#define NODE_MAIN_LOGGER_NAME "ntrip_client_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libntrip_client_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ublox_dgnss::NTRIPClientNode>";
