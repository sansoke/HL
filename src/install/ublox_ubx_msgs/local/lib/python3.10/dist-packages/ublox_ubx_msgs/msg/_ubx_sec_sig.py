...
class Metaclass_UBXSecSig(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ublox_ubx_msgs.msg import JamStateCentFreq
            if JamStateCentFreq.__class__._TYPE_SUPPORT is None:
                JamStateCentFreq.__class__.__import_type_support__()
...
class UBXSecSig(metaclass=Metaclass_UBXSecSig):
    ...
    _fields_and_field_types = {
        ...
        'jam_num_cent_freqs': 'uint8',
        'jam_state_cent_freqs': 'sequence<ublox_ubx_msgs/JamStateCentFreq>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ublox_ubx_msgs', 'msg'], 'JamStateCentFreq')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.jam_num_cent_freqs = kwargs.get('jam_num_cent_freqs', int())
        self.jam_state_cent_freqs = kwargs.get('jam_state_cent_freqs', [])
    ...
    def __eq__(self, other):
        ...
        if self.spoofing_state != other.spoofing_state:
            return False
        if self.jam_num_cent_freqs != other.jam_num_cent_freqs:
            return False
        if self.jam_state_cent_freqs != other.jam_state_cent_freqs:
            return False
        return True
    ...
    @builtins.property
    def jam_num_cent_freqs(self):
        """Message field 'jam_num_cent_freqs'."""
        return self._jam_num_cent_freqs

    @jam_num_cent_freqs.setter
    def jam_num_cent_freqs(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'jam_num_cent_freqs' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'jam_num_cent_freqs' field must be an unsigned integer in [0, 255]"
        self._jam_num_cent_freqs = value

    @builtins.property
    def jam_state_cent_freqs(self):
        """Message field 'jam_state_cent_freqs'."""
        return self._jam_state_cent_freqs

    @jam_state_cent_freqs.setter
    def jam_state_cent_freqs(self, value):
        if __debug__:
            from ublox_ubx_msgs.msg import JamStateCentFreq
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, JamStateCentFreq) for v in value) and
                 True), \
                "The 'jam_state_cent_freqs' field must be a set or sequence and each value of type 'JamStateCentFreq'"
        self._jam_state_cent_freqs = value
